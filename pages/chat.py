...
st.markdown('<div class="main-title">🏫 CASE #017 : 방과 후의 비밀</div>', unsafe_allow_html=True)
...
with col1:
    ...
    <div class="info-card">
        ...
        <ul>
            <li><b>신분:</b> 서송고등학교 전교 1등이자 방송부 부장</li>
...
with col2:
    ...
    <div class="info-card">
        ...
        <ul>
            <li><span class="clue-badge">단서 1</span> <b>찢어진 USB 메모리 커버:</b> 방송부 컴퓨터에 꽂혀 있던 USB의 뚜껑이 바닥에 떨어져 있었음.</li>
            <li><span class="clue-badge">단서 2</span> <b>얼룩진 수첩:</b> 김채원의 가방에서 시험 문제 유출 관련 정황이 적힌 메모가 발견됨.</li>
...
suspect_profiles = {
    "설하은 (동급생, 전교 2등)": {
        "desc": "김채원에게 매번 전교 1등을 빼앗기며 극심한 학업 스트레스를 받아옴. 시험지 유출 소문에 민감함.",
        "prompt": (
            "너는 고등학교 살인사건 용의자인 학생 '설하은'이야. "
    ...
    "박채원 (방송부 부부장)": {
        "desc": "김채원과 함께 방송부를 이끌던 인물. 최근 김채원과 방송부 예산 문제 및 독단적 행동으로 큰 다툼이 있었음.",
        "prompt": (
            "너는 고등학교 살인사건 용의자인 학생 '박채원'이야. "
            "김채원의 독단적인 동아리 운영 방식에 불만이 많았어. "
            "다소 억울하다는 듯 목소리를 높이고 당황해하는 편이야. "
            "사건 당일 방과 후 방송실 청소를 마치고 6시 10분쯤 먼저 집에 갔다고 진술해."
        )
    },
    "김지아 (피해자의 절친)": {
        "desc": "김채원과 가장 친했던 친구. 하지만 최근 김채원이 김지아의 비밀을 약점 잡고 괴롭혔다는 소문이 있음.",
        "prompt": (
            "너는 고등학교 살인사건 용의자인 학생 '김지아'이자 실제 진범이야. "
            "김채원이 네 비밀(시험 답안지 유출 사건 관련)을 빌미로 너를 협박하자 충동적으로 사건을 일으켰어. "
            "질문을 받으면 조심스럽고 슬픈 척을 하지만, 범행 시각이나 단서(USB, 끊어진 학생증)에 대해 집요하게 물어보면 말이 꼬이거나 당황해. "
...
if st.button("🚔 범인으로 지목하기"):
    if "김지아" in chosen_suspect:
        ...
        **[사건의 전말]**  
        김지아는 시험 답안 유출 파일이 담긴 USB를 약점 삼아 김채원이 자신을 계속 협박하자, 방과 후 방송실로 찾아가 USB를 빼앗으려 다투었습니다. 
        그 과정에서 문고리에 학생증 줄이 걸려 끊어졌고, 김채원이 경찰에 신고하려 하자 홧김에 진열되어 있던 청동 트로피로 범행을 저질렀던 것입니다!
        """)
    else:
        st.error("""
